  ...
  group(
    ...
    () {
      ...
      test(
        ...
        () async {
          expect(() => usecase.execute("testecaio2", "1234"), throwsA(isA<AuthException>()));
        },
      );
      test(
        'exception with invalid password length',
        () async {
          expect(() => usecase.execute("testecaio", "1"), throwsA(isA<AuthException>()));
          expect(() => usecase.execute("testecaio2", "123456789012345678901"), throwsA(isA<AuthException>()));
        },
      );
      ...
      test(
        ...
        () async {
          expect(() => usecase.execute("testecaio", "12!34"), throwsA(isA<AuthException>()));
          expect(() => usecase.execute("testecaio2", "1234 "), throwsA(isA<AuthException>()));
        },
      );
      ...
      test(
        ...
        () async {
          expect(() => usecase.execute("t", "1234"), throwsA(isA<AuthException>()));
          expect(() => usecase.execute("testecaiotestecaiotestecaioteste", "1234"), throwsA(isA<AuthException>()));
        },
      );
      ...
      test(
        ...
        () async {
          expect(() => usecase.execute("testecaio ", "1234"), throwsA(isA<AuthException>()));
        },
      );
    },
  );
